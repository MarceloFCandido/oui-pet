                ...
                <Select value={rating} onChange={ratingHandler} fullWidth>
                  ...
                  {ratings.map((rating) => (
                    <MenuItem dispaly="flex" key={rating} value={rating}>
                      ...
                      <Typography component="span">&amp; Mais</Typography>
                    </MenuItem>
                  ))}
                </Select>
              </Box>
        ...
        <Grid item md={9}>
          <Grid container justifyContent="space-between" alignItems="center">
            <Grid item>
              ...
              {rating !== 'all' && ' : Nota ' + rating + ' & mais'}
              {(query !== 'all' && query !== '') ||
              category !== 'all' ||
              brand !== 'all' ||
              rating !== 'all' ||
              price !== 'all' ? (
                <Button onClick={() => router.push('/pesquisar')}>
                  <CancelIcon />
                </Button>
              ) : null}
            </Grid>
            <Grid item>
              ...
              <Select value={sort} onChange={sortHandler}>
                ...
                <MenuItem value="lowest">Preço: Menor - Maior</MenuItem>
                <MenuItem value="highest">Preço: Maior - Menor</MenuItem>
                <MenuItem value="toprated">Avaliação</MenuItem>
